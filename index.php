...
<!--                   <form> -->
                    ...
                    <div class="space">
                      <button type="button" class="login-button"> <b> Log In</b>
                      <span class="loading"><i class="fa fa-spinner fa-spin"></i></span></button>
                    </div>
                    ...
                    <div class="line"></div>
                    <div>
                      <button type="button" class="create-button" id = "create_btn">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-6">
                <input type="text" name="" class="form-control first_name" placeholder="First name">
              </div>
              <div class="col-6">
                <input type="text" name="" class="form-control sur_name" placeholder="Surname">
              </div>
            </div>
            <div class="row">
              <div class="col-12 mt-3">
                <input type="text" name="" class="form-control email_number" placeholder="Email address or phone number">
              </div>
            </div>
            <div class="row">
              <div class="col-12 mt-3">
                <input type="password" name="" class="form-control set_password" placeholder="New password">
              </div>
            </div>
            <div class="row mt-3">
              <label style="font-size: 12px;">Date of birth <i class="fa fa-question-circle"></i></label>
              <div class="col-4">
                <select class="form-select birth_day">
                  <option>1</option>
                  <option>2</option>
                  <option>3</option>
                  <option>4</option>
              ...
              <div class="col-4">
                <select class="form-select birth_month">
                  <option>Jan</option>
                  <option>Feb</option>
                  <option>Mar</option>
                  <option>Apr</option>
              ...
              <div class="col-4">
                <select class="mySelect form-select birth_year"></select>
              </div>
            </div>
          ...
          <div class="modal-footer justify-content-center">
             <button type="button" class="px-5 create-button" id = "sign_up">
                <b>Sign Up</b>
              </button>
          </div>
        </div>
